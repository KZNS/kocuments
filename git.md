...
- [7. 使用建议](#7-使用建议)
  - [7.1. 分支管理](#71-分支管理)
  - [7.2. commit message](#72-commit-message)
    - [7.2.1. Header](#721-header)
      - [7.2.1.1. type](#7211-type)
      - [7.2.1.2. scope](#7212-scope)
      - [7.2.1.3. subject](#7213-subject)
    - [7.2.2. Body](#722-body)
    - [7.2.3. Footer](#723-footer)
      - [7.2.3.1. 不兼容变动](#7231-不兼容变动)
      - [7.2.3.2. 关闭 Issue](#7232-关闭-issue)
    - [7.2.4. Revert](#724-revert)
